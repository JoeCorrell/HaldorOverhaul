...
**[Bows Before Hoes](https://thunderstore.io/c/valheim/p/Azumatt/BowsBeforeHoes/)** by Azumatt — All bows, quivers, and arrows added by this mod are fully supported. Install both mods and they will appear in Haldor's shop automatically. Items are locked behind the same boss progression gates as vanilla items, so they unlock naturally as you play.
